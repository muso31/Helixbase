Function Get-AllTestDllsAsQuotedStrings {
    ...
    Get-ChildItem $sourceFolder -File -Recurse -Filter *.dll |
        Where-Object FullName -Like "*bin\$Configuration\*tests*.dll" |
        ForEach-Object {
...
Function Set-PublishUrl {
    param([Parameter(Mandatory)][string] $configPath, [Parameter(Mandatory)][string] $publishUrl)
