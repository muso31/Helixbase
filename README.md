...
5. Install [Sitecore CLI](https://doc.sitecore.com/developers/100/developer-tools/en/install-sitecore-command-line-interface.html) and push files `dotnet sitecore ser push`
