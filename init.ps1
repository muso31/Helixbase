...
Add-HostsEntry "cm.$rootHostDomain"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.$rootHostDomain"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.$rootHostDomain"
